...
Weather-facing mechanics for the Eberron calendar tool: baseline climate behavior, moon-linked modifiers, planar effects, and event generation rules.
...
- Remove any remaining Shavarath-specific wind effect
