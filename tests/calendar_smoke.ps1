...
Assert-Match 'design/moon-reference-selection\.md' 'Moon-reference archival notes should point at the active design document.'
...
Assert-Match "!cal settings \(group\|labels\|events\|moons\|weather\|weathermechanics\|wxmechanics\|planes\|offcycle\|buttons\)" 'Settings usage text should include wxmechanics and offcycle.'
