...
- **Temperature saves:** At the GM's discretion, creatures make Constitution saves or suffer levels of exhaustion. Recommended to require rolls for each day (or hour, if following the DMG) of travel, each Short or Long Rest, any periods of outdoor activity, and for each combat.
