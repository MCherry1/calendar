...
- **Gregorian** — Standard Earth/Western  calendar
---
## Commands

> In normal play, most interaction happens through the chat buttons generated by `!cal`. When typed syntax matters, the script whispers the correct format in game.
